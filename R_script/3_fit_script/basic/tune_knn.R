# Final Project ----
# Stat 301-2
# Define and fit K-nearest neighbors
...
knn_params <- extract_parameter_set_dials(knn_wflow_basic)|>
  update(
...
# fit workflow/model ----
## Tuning resample
knn_tune_basic <- knn_wflow_basic|>
  tune_grid(
    resamples = hhs_folds,
    grid = knn_grid,
    metrics = my_metrics,
...
save(knn_tune_basic,
     file = here("workflow_fitting/basic/knn_tune_basic.rda"))

save(knn_wflow_basic,
     file = here("workflow_fitting/basic/knn_wflow_basic.rda"))

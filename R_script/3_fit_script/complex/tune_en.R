# Final Project ----
# Stat 301-2
# Define and fit elastic net (complex recipe)
...
en_params <- extract_parameter_set_dials(en_wflow_complex)|>
  update(
...
# fit workflow/model ----
en_tune_complex <- en_wflow_complex|>
  tune_grid(
    resamples = hhs_folds,
    grid = en_grid,
    metrics = my_metrics,
...
save(en_tune_complex,
     file = here("workflow_fitting/complex/en_tune_complex.rda"))

save(en_wflow_complex,
     file = here("workflow_fitting/complex/en_wflow_complex.rda"))
